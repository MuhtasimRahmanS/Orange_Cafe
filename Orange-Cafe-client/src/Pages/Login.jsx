    ...
    <div className="container mx-auto ">
      ...
      >
        ...
        <div className="form-control mt-6">
          <button className="btn bg-[#FF8E01] text-white">Login</button>
        </div>
      </form>
      {loginError && (
      ...
      <div>
        <h3 className="text-center text-2xl font-medium text-[#FF8E01]">
          Login With
        </h3>
      </div>
      <div className=" md:w-3/4 lg:w-1/2 mx-auto  my-6 gap-4 flex justify-center text-white">
        <div>
          <button
            ...
            type="button"
            className="flex items-center justify-center  p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 bg-[#FF8E01] dark:border-gray-600 focus:dark:ring-violet-600"
          >
            <svg
